...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="900" height="320" viewBox="0 0 900 320" preserveAspectRatio="xMidYMid meet" shape-rendering="crispEdges" role="img" aria-labelledby="${titleId} ${descId}" data-theme="${theme}">
  ...
  <defs>
    ...
    <style>
      ...
      .surface{animation:surface 5s steps(4,end) infinite}.theme-accent{animation:accent 6s steps(4,end) infinite alternate}.ray-a{animation:ray 8s steps(8,end) infinite}.ray-b{animation:ray 11s steps(8,end) -4s infinite}.far{animation:drift 16s steps(16,end) infinite}.near{animation:drift 10s steps(12,end) reverse infinite}.plant-motion{transform-box:fill-box;transform-origin:bottom center;animation:sway 3.4s steps(4,end) infinite alternate}.plant-motion.alt{animation-delay:-1.7s}.bubble{animation:rise var(--rise) steps(18,end) var(--wait) infinite}.b1{opacity:.55}.b2{opacity:.8}.b3{opacity:.4}
  ...
  <g clip-path="url(#tank-${theme})">
    ...
    <g data-scene-object="plant" data-safe-zone="underwater" transform="translate(52 236)"><g class="plant-motion"><path d="M10 67V12h8v55zm8-31 20-22v10L18 47zm-8 8L0 28v-9l10 13z" fill="${palette.plant}"/><path d="M14 57V25h4v32z" fill="${palette.plantLight}"/></g></g>
    <g data-scene-object="plant" data-safe-zone="underwater" transform="translate(590 225)"><g class="plant-motion alt"><path d="M12 78V15h8v63zm8-37 21-24v12L20 52zM12 51 0 35V23l12 15z" fill="${palette.plant}"/><path d="M16 65V24h4v41z" fill="${palette.plantLight}"/></g></g>
